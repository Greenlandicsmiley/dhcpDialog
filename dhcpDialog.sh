...
dialog --msgbox "This is a new revised version. If you encounter errors, halts or if you find out the configurations are not correct, then please contact me. My contact info is in the about menu." 0 0
